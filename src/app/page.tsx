      ...
      <main className="flex-1">
        ...
        <section className="mx-auto w-full max-w-6xl px-4 py-16 md:px-6 md:py-24">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              <span className="inline-block rounded-full bg-[#1847CC]/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#1847CC]">
              ...
              <div className="mt-8 space-y-4">
                <Link
                  href="/checkout"
                  className="ix-btn-accent w-full px-6 py-4 text-base shadow-soft sm:w-auto sm:px-10 sm:text-lg"
                >
        ...
        <section className="mx-auto w-full max-w-6xl px-4 py-16 md:px-6 md:py-20">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {passos.map((p, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex size-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#1847CC]/15 to-[#F55028]/15 text-2xl">
                    {p.emoji}
                  </div>
          ...
          <div className="grid items-start gap-10 md:grid-cols-2">
            ...
            <ul className="grid gap-3 sm:grid-cols-1">
              {beneficios.map((b) => (
                ...
                >
                  <span className="mt-0.5 flex size-6 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#1847CC] to-[#F55028] text-xs font-bold text-white">
                    ✓
                  </span>
              ...
              {faqs.map((f) => (
                ...
                >
                  <summary className="flex cursor-pointer items-center justify-between gap-4 text-base font-bold text-[#16120E]">
                    {f.q}
                    <span className="text-[#1847CC] transition group-open:rotate-45">+</span>
                  </summary>
        ...
        >
          <div className="mx-auto w-full max-w-3xl px-4 md:px-6">
            ...
            <Link
              href="/checkout"
              className="mt-8 inline-flex items-center justify-center rounded-2xl bg-white px-8 py-4 text-base font-extrabold text-[#1847CC] shadow-2xl transition hover:scale-[1.02] md:text-lg"
            >
